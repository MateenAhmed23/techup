  ...
  return (
    <nav>
        ...
        <div className={`dropdown-content ${dropdownOpen ? 'show' : ''}`}>
          <a onClick={() => props.onnavclick("home")} className="commonitems active" href="#">
            Home
          </a>
          <a onClick={() => props.onnavclick("services")} className="commonitems" href="#">
            Services
          </a>
          <a onClick={() => props.onnavclick("aboutus")} className="commonitems" href="#">
            About Us
          </a>
          <a onClick={() => props.onnavclick("pricing")} className="commonitems" href="#">
            Pricing
          </a>
        ...
        <a onClick={() => props.onnavclick("contractus")} className="contractus" href="#">
          Contact Us
        </a>
        {isLoggedIn ? 
